...
ALL_TOOLS: Dict[str, Dict[str, Any]] = {
    ...
    "edit_html": {
        ...
        "function": {
            "name": "edit_html",
            "description": "Edit the product landing page at workspace/landing.html by replacing one piece of text with another. Use this to update the headline, a button label, a tagline, etc. on a page that was previously generated by html_assistant. The change is applied to the file and the live preview re-renders.",
            "parameters": {
                "type": "object",
                "properties": {
...
async def _tool_edit_html(args: Dict[str, Any]) -> str:
    ...
    try:
        p = _resolve_safe("workspace/landing.html")
        if not p.exists():
            return json.dumps({"error": "workspace/landing.html not found; generate it first via html_assistant"})
